...
class LabelSmoothing(nn.Module):
    ...
    def __init__(self, size, smoothing=0.0):
        ...
        #self.criterion      = nn.NLLLoss(reduction='none')  # Jia change
        #self.criterion      = nn.CrossEntropyLoss()  # Jia change, if CrossEntropyloss, remove logsoft in forword function in decodertransformer
